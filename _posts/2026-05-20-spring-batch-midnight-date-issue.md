...
이 조건이 겹치면 같은 배치 실행 안에서도 날짜가 달라질 수 있습니다.
...
이런 조건이 있으면 루프 도중 자정을 넘길 수 있고, 그 순간부터 일부는 어제 날짜, 일부는 오늘 날짜로 처리됩니다.
...
이렇게 바꾸면 배치가 `00:30`까지 이어져도 날짜 기준은 끝까지 동일합니다.
...
결국 중요한 것은 "지금 몇 시인가"가 아니라 **이번 배치가 언제 시작됐는가**였습니다.
